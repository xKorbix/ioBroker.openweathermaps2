    ...
    calculationList: [
        {
            ...
            calculate: async function (adapter) {
                ...
                if (startDate == null || startDate.val == null || endDate == null || endDate.val == null)
                    return;
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[0].name, { val: startDate.val.toString(), ack: true });
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[1].name, { val: endDate.val.toString(), ack: true });
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[3].name, { val: volume_sum, ack: true });
        ...
        },
        {
            ...
            calculate: async function (adapter) {
                ...
                for (let idx = 0; idx < Object.keys(states2).length; idx++) {
                    ...
                    if (statePop == null || statePop.val == null)
                        continue;
                    if ((stateRain == null || stateRain.val == null) && (stateSnow == null || stateSnow.val == null))
                        continue;
                    if (statePop.val > 25) {
                        if (startIdx < 0)
                            startIdx = idx;
                ...
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[0].name, { val: startDate.val.toString(), ack: true });
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[1].name, { val: endDate.val.toString(), ack: true });
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[2].name, { val: popAvg, ack: true });
                await adapter.setStateAsync(exports.calculations.root + '.' + this.results[3].name, { val: volume_sum, ack: true });
